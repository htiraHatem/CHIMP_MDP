...
public class Method {
	 ...
	 * 
	 * @param domain TODO
	 * @return TODO Fix this for when the same task is executed multiple times
	 */
...
//			Constraint cInstance = new Constraint(instMap[i1], instMap[i2]);
	...
	/**
	 * Returns whether or not this method is applicable to {@link State}
	 * <code>s</code>. XXX Review this
	 * 
	 * @param s
	 * @param u
	 * @return
...
//		}
	...
	/**
	 * Returns all possible unifiers in which {@link State} <code>s</code> can
	 * support this method.
	 * 
	 * @param s
	 * @param u
